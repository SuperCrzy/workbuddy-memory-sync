...
def generate_gif(output_path: str):
    scenes = [
        ...
        [
            ...
            "",
            "[WORKBUDDY]",
            "  workspaces/20260424095145: 2 .md files  (~/.WorkBuddy/.../.workbuddy/memory)",
            "  __user__: 1 .md file  (~/.workbuddy/memory)",
            "",
            "[OPENCLAW]",
        ...
        [
            ...
            "[INFO] Syncing agent=all, found 7 source(s)...",
            "  workbuddy/workspaces/20260424095145: 2 file(s)",
            "  workbuddy/__user__: 1 file(s)",
            "  openclaw/workspace: 4 file(s)",
            "  hermes/memories: 1 file(s)",
            "  cursor/rules: 3 file(s)",
            "",
            "[OK] Push successful! Synced 15 file(s) from 7 source(s)",
        ],
        # Scene 3: pull
        [
            "$ python memory_sync.py pull --agent all",
            "[INFO] Pulling latest memory from GitHub (agent=all)...",
            "  workbuddy/workspaces/20260424095145: 2 file(s) updated",
            "  workbuddy/__user__: 1 file(s) updated",
        ...
        [
            ...
            "Local cache : C:/Users/admin/.workbuddy/memory-sync-repo",
            "Platform    : Windows 10",
            "Hostname    : home-pc",
            "",
            "Last 5 syncs:",
            "  abc1234 sync(workbuddy): 2026-04-24 11:00:00 from home-pc (15 files)",
            "  def5678 sync(openclaw): 2026-04-24 10:55:00 from home-pc (4 files)",
            "  ghi9012 sync(hermes): 2026-04-24 10:50:00 from home-pc (1 files)",
            "",
